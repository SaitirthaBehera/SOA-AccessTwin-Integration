    ...
    <div id="section-home-dashboard" className="space-y-10">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-indigo-950 text-white rounded-3xl p-8 border border-slate-800 shadow-xl grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
        ...
        <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-4">
          {[
            { label: 'Wheelchair Ramp Access', score: selectedBuilding.scores.wheelchair },
            { label: 'Tactile & Visual Guidance', score: selectedBuilding.scores.visual },
            { label: 'Hearing & Assistive Signals', score: selectedBuilding.scores.hearing },
            { label: 'High Contrast Signage', score: selectedBuilding.scores.signage },
            { label: 'Accessible Restrooms', score: selectedBuilding.scores.restrooms },
            { label: 'Indoor Navigation Graph', score: selectedBuilding.scores.navigation },
          ].map((item, idx) => (
